...
void create_califa_single_crystal(const char* geoTag = "teetos")
{
  ...
  Double_t rotAngle=0;
  phiEuler = 180;
  thetaEuler = 0; //180.*TMath::ATan2(-0.6560740922919081600,-0.7546964856307127900)/TMath::Pi();
  psiEuler = 0;
  
  //CRYSTAL NO MEIO A ADICIONAR (BANANA)
